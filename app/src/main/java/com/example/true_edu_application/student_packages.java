...
public class student_packages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_packages);
...
//                    startActivity(intent2);
                    startActivity(new Intent(student_packages.this, DashboardActivity.class));
                    finish();
...
//                    startActivity(intent3);
                    ...
                    startActivity(new Intent(student_packages.this, student_packages.class));
                    finish();

                } else if (id == MENU_ITEM_5) {

                    startActivity(new Intent(student_packages.this, selected_packages.class));
                    finish();
    ...
    public class MyAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        private static final String METHOD_NAME = "get_pckgbyuserid_sts_true";
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    CustomGridAdapter adapter = new CustomGridAdapter(student_packages.this, packIDs, packNames);
